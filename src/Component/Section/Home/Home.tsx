  ...
  return (
    <div className='w-full flex flex-col justify-center lg:px-16 xl:px-32 2xl:px-64 pt-24 pb-64'>
        <div className='flex w-full flex-col-reverse xl:flex-row justify-between gap-20'>
            <div className='flex flex-col gap-16 xl:pt-16 w-full xl:w-[40%] px-8 xl:px-0 '>
                <div className='flex flex-col gap-5'>
                    <h2 className='text-primary text-xl xl:text-2xl font-medium tracking-widest' style={{ textShadow: '0px 0px 10px #a855f740'}}>Lemine Mahjoub &gt;</h2>
                    <h1 className='text-2xl xl:text-4xl text-white tracking-wider'><span style={{ textShadow: '0px 0px 10px #ffffff90'}}>Front-End Developer</span><span className='text-[#6600F8] font-semibold' style={{ textShadow: '0px 0px 10px #a855f720'}}> & <br />Software Developer.</span></h1>
                    <p className='text-gray-400 font-light text-xs xl:text-sm' style={{ textShadow: '0px 0px 10px #ffffff20'}}>
                ...
                <div className='flex gap-8 flex-col lg:flex-row w-full px-4'>
            ...
            <div className='w-full xl:w-[32.5%] h-auto flex justify-center items-center'>
                <img src={Profilepicture} alt="Lemine Mahjoub Profile Picture"
                className='h-auto w-1/2 xl:w-full aspect-square rounded-full border-[2px] border-gray-800'
